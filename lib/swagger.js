...
(function() {
  ...
  SwaggerModel = (function() {
    ...
    SwaggerModel.prototype.getMockSignature = function(modelsToIgnore) {
      var classClose, classOpen, prop, propertiesStr, returnVal, strong, strongClose, stronger, _i, _len, _ref;
      propertiesStr = [];
      _ref = this.properties;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        prop = _ref[_i];
  ...
  SwaggerModelProperty = (function() {
    ...
    SwaggerModelProperty.prototype.toString = function() {
      ...
      str = '<span class="propName ' + req + '" data-toggle="tooltip" title="' + (this.descr || '') + '">' + this.name + '</span> (<span class="' + (this.refModel ? '' : 'propType') + '">' + (this.refModel ? this.refModel.getMockSignature([]) : this.dataTypeWithRef) + '</span>';
      if (!this.required) {
